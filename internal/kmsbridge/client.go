...
// looks like "brand/hanzo/plivo/auth-id" — the last segment is the
...
// splitSecretPath splits "brand/hanzo/plivo/auth-id" into
// (path="brand/hanzo/plivo", name="auth-id"). For a single-segment
