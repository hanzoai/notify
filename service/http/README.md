...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/hanzo-iam/notify2/service/http)
...
See our [Notify Test Server](https://github.com/hanzo-iam/notify2-http-test) for a simple HTTP server that can be used for testing.
...
import (
	...
	"github.com/hanzo-iam/notify2/service/http"
)
...
func main() {
	...
	// Notify's test http server: https://github.com/hanzo-iam/notify2-http-test. It supports multiple content-types on the
